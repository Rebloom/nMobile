...
class NKNTextFormField extends FormField<String> {
  NKNTextFormField({
    Key key,
    this.controller,
    String initialValue,
    FocusNode focusNode,
    m.InputDecoration decoration = const m.InputDecoration(),
    ...
    AutovalidateMode autovalidateMode,
        ...
        assert(autovalidate == false || autovalidate == true && autovalidateMode == null, 'autovalidate and autovalidateMode should not be used together.'),
        ...
        super(
          ...
          builder: (FormFieldState<String> field) {
            ...
            final m.InputDecoration effectiveDecoration = (decoration ?? const m.InputDecoration()).applyDefaults(m.Theme.of(field.context).inputDecorationTheme);
...
class _TextFormFieldState extends FormFieldState<String> {
  ...
  @override
  NKNTextFormField get widget => super.widget as NKNTextFormField;
  ...
  @override
  void didUpdateWidget(NKNTextFormField oldWidget) {
